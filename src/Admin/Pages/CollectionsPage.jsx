        ...
        <tbody>
          {collections.map((collection, index) => (
            <tr key={collection._id} className="border-b">
              ...
              <td className="px-4 py-2 text-sm text-gray-900">{collection.description}</td>
              <td className="px-4 py-2 text-sm text-gray-900">{collection.adress || "N/A"}</td>
              <td className="px-4 py-2 text-sm text-gray-900">{collection.rating}</td>
              <td className="px-4 py-2 text-sm text-gray-900">{collection.category}</td>
              <td className="px-4 py-2 text-sm text-gray-900">{collection.state}</td>
              <td className="px-4 py-2 text-sm text-gray-900">
                {collection.state === "promo" ? collection.pourcentage : "N/A"}
              </td>
              <td className="px-4 py-2 text-sm text-gray-900">
                <label className="inline-flex relative items-center cursor-pointer">
                  <input
                    ...
                    checked={collection.isvalidated}
                    onChange={() => handleValidationToggle(collection._id, collection.isvalidated)}
                  />
