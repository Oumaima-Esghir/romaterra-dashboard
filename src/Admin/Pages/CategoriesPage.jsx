      ...
      <table className="w-full bg-white shadow-md rounded-lg">
        ...
        <tbody>
          {categories.map((categorie, index) => (
            <tr key={categorie._id} className="border-b">
              ...
              <td className="px-4 py-2 text-sm text-gray-900">{categorie.description}</td>
              <td className="px-4 py-2 text-sm text-gray-900">{categorie.adress || "N/A"}</td>
              <td className="px-4 py-2 text-sm text-gray-900">{categorie.rating}</td>
              <td className="px-4 py-2 text-sm text-gray-900">{categorie.category}</td>
              <td className="px-4 py-2 text-sm text-gray-900">{categorie.state}</td>
              <td className="px-4 py-2 text-sm text-gray-900">
                {categorie.state === "promo" ? categorie.pourcentage : "N/A"}
              </td>
              <td className="px-4 py-2 text-sm text-gray-900">
                <label className="inline-flex relative items-center cursor-pointer">
                  <input
                    ...
                    checked={categorie.isvalidated}
                    onChange={() => handleValidationToggle(categorie._id, categorie.isvalidated)}
                  />
